...
-	*EXTRA RESOURCES*: Marking received messages as read and a   dive into BOT API v2 and inline stuff!
...
Now that we have experienced how seamlessly the WEB API works (I hope you did not skip), let us trace down every line: <br />This is requests, an alternative to Python’s built-in URLLIB. This needs to be installed via *pip* (command in workshop requisites section) if you’re running this off your own PC. 
